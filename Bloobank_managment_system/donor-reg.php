...
<div id="full">
	<div id="inner_full">
		<div id="header"><a href="Login.php" style="text-decoration: none; color: white;"><h2>Blood Bank management System</a></h2></div>
		<div id="body"><br>
...
if(isset($_POST['sub']))
{
    try {
        ...
        $pdoConnect = new PDO("mysql:host=localhost;dbname=bloodbank","root","");
